...
public class Game {
     ...
     */
    @Getter
    private final net.mcxk.hjyhunt.game.GameProgressManager progressManager = new GameProgressManager();
    /**
     * 结算统计信息
     */
    @Getter
    ...
    @Getter
    @Setter
    private net.mcxk.hjyhunt.game.GameStatus status = net.mcxk.hjyhunt.game.GameStatus.WAITING_PLAYERS;
    /**
     * 玩家角色
     * 线程安全
     */
     ...
     */
    public Optional<net.mcxk.hjyhunt.game.PlayerRole> getPlayerRole(Player player) {
    ...
    public void start() {
        ...
        Bukkit.broadcastMessage(ChatColor.AQUA + "欢迎来到 " + ChatColor.GREEN + "HJYHunt " + ChatColor.AQUA + "!");
